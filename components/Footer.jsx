  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          href="#"
          className="font-display text-lg text-ink hover:text-[#3B6FE8] transition-colors duration-200"
        >
        ...
        <p className="font-body text-sm text-subtle text-center">
          © {year} Tioluwanimi Ayomide Adeagbo. Built with Next.js & Tailwind CSS.
        </p>
